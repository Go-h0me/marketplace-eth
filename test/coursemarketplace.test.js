...
contract("CourseMarketplace", (accounts) => {
  ...
  describe("Purchase the new course", () => {
    ...
    it("can get the purchased course hash by index", async () => {
      ...
      assert.equal(
        courseHash,
        expectedHash,
        "Course hash should matching the has of purchased course"
      );
    });
    it("should match the purchased data of the course purchased by buyer", async () => {
      ...
      assert.equal(course.price, value, `Course price should ${value} !`);
  ...
  describe("Repurchase course", () => {
    ...
    it("should be able repurchase with the original buyer", async () => {
      ...
      // const gasUsed = toBN(result.receipt.gasUsed);
      // const gasPrice = toBN(tx.gasPrice);
      // const gas = gasUsed.mul(gasPrice); lay o tren gon r ong noi
      const gas = await getGas(result);
